...
Public Class distributorform
    ...
    Private Sub distributorform_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub distributorform_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Me.Hide()
        mainform.Show()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.clear()
        distributordetails1.DataGridView1.DataSource = Nothing
        distributordetails1.DataGridView2.DataSource = Nothing
        distributordetails1.txtName.Text = ""
