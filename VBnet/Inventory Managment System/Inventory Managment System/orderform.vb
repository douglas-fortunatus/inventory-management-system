...
Public Class orderform
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Me.clear()
        orderRecordForm.fillorderNo()
        orderRecordForm.DataGridView1.DataSource = Nothing
        orderRecordForm.dtpOrderDateFrom.Text = Today
        orderRecordForm.dtpOrderDateTo.Text = Today
        orderRecordForm.DataGridView6.DataSource = Nothing
        orderRecordForm.cmbCustomerName.Text = ""
        orderRecordForm.DataGridView3.DataSource = Nothing
        orderRecordForm.cmbStatus.Text = ""
        orderRecordForm.DataGridView2.DataSource = Nothing
        orderRecordForm.cmbOrderNo.Text = ""
        orderRecordForm.cmbProductName.Text = ""
        orderRecordForm.DataGridView5.DataSource = Nothing
        orderRecordForm.Show()
    End Sub
