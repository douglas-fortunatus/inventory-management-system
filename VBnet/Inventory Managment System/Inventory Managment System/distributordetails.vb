...
Public Class distributordetails
    ...
    Private Sub distributordetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        fillName()
    ...
    Private Sub DataGridView2_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView2.RowHeaderMouseClick
        Try
            ...
            Me.Hide()
            salesform.Show()
            salesform.txtCustomerNo.Text = dr.Cells(0).Value.ToString()
            salesform.txtCustomerName.Text = dr.Cells(1).Value.ToString()
