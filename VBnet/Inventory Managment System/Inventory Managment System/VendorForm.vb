...
Public Class VendorForm
    ...
    Sub clear()
        ...
        inpVendorID.Text = ""
        inpVendorName.Text = ""
        inpVendorAddress.Text = ""
        inpVendorlandmark.Text = ""
        cbState.Text = ""
        inpZip.Text = ""
        inpPhone.Text = ""
    ...
    Private Sub auto()
        inpVendorID.Text = "V-" & GetUniqueKey(6)
    End Sub
    ...
    Private Sub Save_Click(sender As Object, e As EventArgs) Handles Save.Click
        ...
        If Len(Trim(inpMobile.Text)) = 0 Then
        ...
        Try
            ...
            cmd.Parameters("@find").Value = inpVendorID.Text
            ...
            Else
                ...
                cmd.Parameters("@d1").Value = inpVendorID.Text
                cmd.Parameters("@d2").Value = inpVendorName.Text
                cmd.Parameters("@d4").Value = inpVendorAddress.Text
                cmd.Parameters("@d5").Value = inpVendorlandmark.Text
                cmd.Parameters("@d6").Value = inpCty.Text
                cmd.Parameters("@d7").Value = cbState.Text
                cmd.Parameters("@d8").Value = inpZip.Text
                cmd.Parameters("@d9").Value = inpPhone.Text
                cmd.Parameters("@d10").Value = inpEmail.Text
                cmd.Parameters("@d11").Value = inpMobile.Text
                cmd.Parameters("@d12").Value = inpFax.Text
                cmd.Parameters("@d13").Value = inpNotes.Text
    ...
    Public Sub delete_record()
        Try
            ...
            cmd.Parameters("@DELETE1").Value = Trim(inpVendorID.Text)
    ...
    Private Sub VendorForm_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Me.Hide()
        mainform.Show()
    End Sub

    Private Sub inpEmail_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles inpEmail.Validating
        ...
        If inpEmail.Text.Length > 0 Then
            If Not rEMail.IsMatch(inpEmail.Text) Then
    ...
    Private Sub inpPhone_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles inpPhone.KeyPress
    ...
    Private Sub inpFax_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles inpFax.KeyPress
        If (e.KeyChar < Chr(48) Or e.KeyChar > Chr(57)) And e.KeyChar <> Chr(8) Then
